...
$$.Closure$main = [U, {"": "Closure;call$0,$name"}];
...
["letter_frequency.dart", "letter_frequency.dart", , U, {
main: function() {
  var textArea, lettersArea, lettersButton, clearButton, t1, t2, t3;
  textArea = document.querySelector("#text");
  lettersArea = document.querySelector("#letters");
  lettersButton = document.querySelector("#frequency");
  clearButton = document.querySelector("#clear");
  lettersButton.get$onClick;
  C.EventStreamProvider_click.forElement$2$useCapture;
  t1 = C.EventStreamProvider_click._eventType;
  t2 = new W._ElementEventStreamImpl(lettersButton, t1, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, new U.main_closure(textArea, lettersArea), t2._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t3._tryResume$0();
  clearButton.get$onClick;
  t1 = new W._ElementEventStreamImpl(clearButton, t1, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, new U.main_closure0(textArea, lettersArea), t1._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t3._tryResume$0();
},

main_closure: {"": "Closure;textArea_0,lettersArea_1",
  call$1: function(e) {
    var t1, t2, text, textWhithoutChr, finalText, t3, t4, letter, cmpt, lastPosition, newPosition;
    t1 = this.lettersArea_1;
    t2 = J.getInterceptor$x(t1);
    t2.set$value(t1, "letters: frequency \n");
    text = J.get$value$x(this.textArea_0);
    if (text !== "") {
      textWhithoutChr = J.replaceAll$2$s(text, new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative("[-,;:.?!()'`\u2019\u201c\"\n]", false, true, false), null, null), "");
      finalText = H.stringReplaceAllUnchecked(textWhithoutChr, " ", "").toLowerCase();
      for (t3 = new H.ListIterator($.get$lettersList(), 38, 0, null), t4 = finalText.length - 1; t3.moveNext$0();) {
        letter = t3._current;
        if (C.JSString_methods.indexOf$1(finalText, letter) !== -1)
          for (cmpt = 0, lastPosition = 0; lastPosition <= t4; lastPosition = newPosition + 1) {
            newPosition = C.JSString_methods.indexOf$2(finalText, letter, lastPosition);
            if (newPosition === -1) {
      ...
      t2.set$value(t1, "Entrez du texte dans le cadran sup\u00e9rieur!");
  }
},

main_closure0: {"": "Closure;textArea_2,lettersArea_3",
  call$1: function(e) {
    J.set$value$x(this.textArea_2, "");
    J.set$value$x(this.lettersArea_3, "");
  }
}},
1],
]);
...
Isolate.$lazy($, "lettersList", "lettersList", "get$lettersList", function() {
  return ["a", "\u00e0", "\u00e4", "\u00e2", "b", "c", "d", "e", "\u00e9", "\u00eb", "\u00e8", "\u00ea", "f", "g", "h", "i", "\u00ef", "\u00ee", "j", "k", "l", "m", "n", "o", "\u00f6", "\u00f4", "p", "q", "r", "s", "t", "u", "\u00f9", "v", "w", "x", "y", "z"];
});
// Native classes
...
//# sourceMappingURL=letter_frequency.dart.js.map
//@ sourceMappingURL=letter_frequency.dart.js.map
